# 🎵 Аудіо Рекордер та Редактор v1.0.4
...
- Веб-розробку (Streamlit)
- Машинне навчання (NoiseReduce)
...
### Варіант 2: Streamlit (веб-версія)
1. Встановіть: `pip install streamlit`
2. Запустіть: `streamlit run audio_editor_streamlit.py`
3. Відкрийте браузер: http://localhost:8501

### Варіант 3: Replit
1. Імпортуйте репозиторій в Replit
2. Запустіть: `python audio_editor_replit.py`

## 📁 Файли проекту

- `audio_recorder_editor.py` - **Основна програма** (PyQt5 GUI)
- `audio_editor_streamlit.py` - Веб-версія (Streamlit)
- `audio_editor_replit.py` - Консольна версія (Replit)
...
- **🔇 Видалення шуму** - використання алгоритмів машинного навчання
